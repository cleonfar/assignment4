---
timestamp: 'Tue Nov 04 2025 18:22:56 GMT-0500 (Eastern Standard Time)'
parent: '[[..\20251104_182256.d515cc55.md]]'
content_id: 2858b4cbac975e83140cefa8f33edfdbbb064d66a1766f7b1d5c7999f42f3b2a
---
...
* **actions**
  * `recordWeight (animal: ID, date: Date, weight: Number, notes: String)`
    * **requires** animal exists
    * **effects** create a new weight record for this animal

  * `removeWeightRecord (animal: ID, date: Date)`
  ...
  * `deleteAnimal (animal: ID, user: String): Empty`
