---
timestamp: 'Sat Oct 18 2025 14:57:58 GMT-0400 (Eastern Daylight Time)'
parent: '[[..\20251018_145758.bfc70f2b.md]]'
content_id: d54f434a6866302829ad232906f1ee1f8bf580cb68ee204697333daa12596a92
---
  ...
  async recordWeight(
    ...
    const result = await this.animals.updateOne(
      { _id: animal },
      {
        ...
        $setOnInsert: { _id: animal, weightRecords: [] }, // Initialize if new
      },
      { upsert: true },
    );
