---
timestamp: 'Sat Oct 18 2025 18:09:22 GMT-0400 (Eastern Daylight Time)'
parent: '[[..\20251018_180922.aad61da1.md]]'
content_id: 949559fe331adc09bc95fb3464fd62076b36a6edeafa458fe391e6dc6d92bc9e
---
...
Deno.test("GrowthTrackingConcept - AI Features (aiSummary action, _getAiSummary query)", async (t) => {
  ...
  await t.step("aiSummary action: should successfully generate and save an AI summary for an existing report", async () => {
    ...
    try {
      ...
      throw new Error(`Generated summary is not valid JSON: ${e.message}`);
    }
