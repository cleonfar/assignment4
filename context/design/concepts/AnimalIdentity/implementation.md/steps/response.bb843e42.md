---
timestamp: 'Fri Oct 17 2025 15:37:14 GMT-0400 (Eastern Daylight Time)'
parent: '[[..\20251017_153714.2e8e20cd.md]]'
content_id: bb843e420fa341ff2eb7c3f3280d52bd9ddec06c5e0a287ed374082a7dc26ea5
---
...
import { Empty, ID, UNKNOWN_FATHER, UNKNOWN_MOTHER } from "@utils/types.ts";
...
interface AnimalDocument {
  ...
  mother: ID; // Using UNKNOWN_MOTHER for optional ID
  father: ID; // Using UNKNOWN_FATHER for optional ID
...
export default class AnimalIdentityConcept {
  ...
  async registerAnimal(
    ...
    const newAnimal: AnimalDocument = {
      ...
      mother: mother ?? UNKNOWN_MOTHER, // Use sentinel for optional ID
      father: father ?? UNKNOWN_FATHER, // Use sentinel for optional ID
  ...
  async removeParent(
    ...
    const unknownParentSentinel = parentType === "mother" ? UNKNOWN_MOTHER : UNKNOWN_FATHER;
    ...
    try {
      ...
      const updateFields: Partial<AnimalDocument> = {};
      if (parentType === "mother") {
        updateFields.mother = UNKNOWN_MOTHER;
      } else {
        updateFields.father = UNKNOWN_FATHER;
      }
