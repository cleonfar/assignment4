---
timestamp: 'Fri Oct 17 2025 16:34:02 GMT-0400 (Eastern Daylight Time)'
parent: '[[..\20251017_163402.9b2c95d4.md]]'
content_id: b50f5b9656d03897468f5880ffa9a7231a88858454f251b1a23b53ddcf597bb7
---

# response:

You are absolutely correct! `AnimalDocument` is an internal representation of the concept's state and should not be exported from `AnimalIdentityConcept.ts`. It's an implementation detail, and the public interface of the concept is defined by its actions and queries.

My apologies for that oversight. I've corrected the test file to remove the invalid import and adjusted the type handling for `fetchedAnimal` accordingly.
...
// Removed: import { AnimalDocument } from "./AnimalIdentityConcept.ts";
...
Deno.test("AnimalIdentityConcept: registerAnimal action", async (t) => {
  ...
  await t.step("should successfully register an animal with all fields provided", async () => {
    ...
    // Type of fetchedAnimal is correctly inferred as AnimalDocument from the _getAnimal return type
