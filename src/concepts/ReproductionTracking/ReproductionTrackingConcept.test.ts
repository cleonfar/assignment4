...
import { ID, UNKNOWN_FATHER_ID } from "@utils/types.ts";
...
Deno.test("ReproductionTrackingConcept - addMother action", async (t) => {
  ...
  await t.step(
    "should successfully add a new mother and set notes to empty string",
    async () => {
      ...
      assertEquals(
        addedMother.notes,
        "",
        "Notes should be an empty string if not provided during addMother",
      );
    },
  );

  await t.step(
    "should return an error if mother with ID already exists",
    async () => {
      const motherId = "mother:Alice" as ID;

      await concept.addMother({ motherId: motherId as string }); // First add
      const secondAddResult = await concept.addMother({
        motherId: motherId as string,
      });

      assertEquals(
        secondAddResult.error,
        `Mother with ID '${motherId}' already exists.`,
      );
...
Deno.test("ReproductionTrackingConcept - removeMother action", async (t) => {
  ...
  await t.step("should successfully remove an existing mother", async () => {
    ...
    assertEquals(
      removedMother,
      null,
      "Mother should no longer exist after removal",
    );
  });

  await t.step(
    "should return an error if mother with ID does not exist",
    async () => {
      ...
      assertEquals(
        nonExistentMother,
        null,
        "Mother should not exist initially",
      );

      const removeResult = await concept.removeMother({
        motherId: nonExistentMotherId as string,
      });

      assertEquals(
        removeResult.error,
        `Mother with ID '${nonExistentMotherId}' not found.`,
      );
      assertEquals(removeResult.motherId, undefined);

      const count = await concept.mothers.countDocuments({
        _id: nonExistentMotherId,
      });
...
Deno.test("ReproductionTrackingConcept - recordLitter action", async (t) => {
  ...
  await t.step(
    "should successfully record a litter and auto-add a new mother",
    async () => {
      ...
      const preExistingMother = await concept.mothers.findOne({
        _id: motherId,
      });
      assertEquals(
        preExistingMother,
        null,
        "Mother should not exist before action",
      );
      ...
      assertEquals(
        newLitter?.fatherId,
        fatherId,
        "fatherId should match provided fatherId",
      );
      ...
      assertEquals(
        addedMother?.notes,
        "",
        "Auto-added mother's notes should be empty string",
      );
    },
  );

  await t.step(
    "should successfully record a litter with an existing mother and empty notes",
    async () => {
      ...
      await concept.addMother({ motherId: motherId as string });
      const initialMotherCount = await concept.mothers.countDocuments({
        _id: motherId,
      });
      ...
      assertEquals(
        newLitter?.notes,
        "",
        "Notes should be an empty string if not provided",
      );

      const finalMotherCount = await concept.mothers.countDocuments({
        _id: motherId,
      });
  ...
  await t.step(
    "should successfully record a litter without a father, using UNKNOWN_FATHER_ID and empty notes",
    async () => {
      ...
      assertEquals(
        newLitter?.fatherId,
        UNKNOWN_FATHER_ID,
        "fatherId should be UNKNOWN_FATHER_ID when not provided",
      );
      assertEquals(
        newLitter?.notes,
        "",
  ...
  await t.step(
    "should return an error for duplicate litter (mother, specific father, birthDate)",
    async () => {
      ...
      const initialLitterCount = await concept.litters.countDocuments({
        motherId,
        fatherId,
        birthDate,
      });
      assertEquals(
        initialLitterCount,
        1,
        "Litter should exist before duplicate attempt",
      );
      ...
      assertExists(
        secondResult.error,
        "Error should be returned for duplicate",
      );
      assertEquals(secondResult.litterID, undefined);
      assertEquals(
        secondResult.error,
        `A litter with mother ${motherId}, father ${fatherId}, and birth date ${birthDate.toISOString()} already exists.`,
      );

      const finalLitterCount = await concept.litters.countDocuments({
        motherId,
        fatherId,
        birthDate,
      });
  ...
  await t.step(
    "should return an error for duplicate litter (mother, UNKNOWN_FATHER_ID, birthDate)",
    async () => {
      ...
      assertEquals(
        initialLitterCount,
        1,
        "Litter (UNKNOWN_FATHER_ID) should exist before duplicate attempt",
      );
      ...
      assertEquals(
        secondResult.error,
        `A litter with mother ${motherId}, father none, and birth date ${birthDate.toISOString()} already exists.`,
      );
      ...
      assertEquals(
        finalLitterCount,
        1,
        "Only one litter (UNKNOWN_FATHER_ID) should exist",
      );
    },
  );
...
Deno.test("ReproductionTrackingConcept - updateLitter action", async (t) => {
  ...
  await t.step(
    "should successfully update a single field (reportedLitterSize)",
    async () => {
      ...
      assertEquals(
        updatedLitter?.motherId,
        motherId,
        "Other fields should remain unchanged",
      );
      assertEquals(
        updatedLitter?.fatherId,
        fatherId,
        "Other fields should remain unchanged",
      );
      assertEquals(
        updatedLitter?.birthDate.toISOString(),
  ...
  await t.step(
    "should successfully update multiple fields (birthDate, notes)",
    async () => {
  ...
  await t.step(
    "should successfully update fatherId from specific to new specific",
    async () => {
  ...
  await t.step(
    "should successfully update fatherId from specific to UNKNOWN_FATHER_ID (by passing undefined)",
    async () => {
      const updateResult = await concept.updateLitter({
        litterId: litterId as string,
  ...
  await t.step(
    "should successfully update fatherId from UNKNOWN_FATHER_ID to specific",
    async () => {
  ...
  await t.step(
    "should successfully update motherId to an existing mother",
    async () => {
  ...
  await t.step(
    "should successfully update motherId to a new mother (auto-creation)",
    async () => {
      const newMotherId = "mother:NewMotherForLitter" as ID;

      // Ensure newMotherId does not exist initially
      const preExistingNewMother = await concept.mothers.findOne({
        _id: newMotherId,
      });
      assertEquals(
        preExistingNewMother,
        null,
        "New mother should not exist before update",
      );
      ...
      const addedNewMother = await concept.mothers.findOne({
        _id: newMotherId,
      });
      assertExists(addedNewMother, "New mother should have been auto-added");
      assertEquals(
        addedNewMother?.notes,
        "",
        "Auto-added new mother's notes should be empty string",
      );
    },
  );

  await t.step(
    "should successfully update notes to an empty string when undefined is passed",
    async () => {
      ...
      assertEquals(
        updatedLitter?.notes,
        "",
        "Notes should be an empty string when undefined is passed",
      );
    },
  );

  await t.step(
    "should not change notes if notes field is not provided in update arguments",
    async () => {
      ...
      assertEquals(
        currentLitter?.notes,
        "Original specific notes for non-update test",
      );
      ...
      assertEquals(
        updatedLitter?.notes,
        "Original specific notes for non-update test",
        "Notes should remain unchanged if not provided in args",
      );
    },
  );

  await t.step(
    "should return an error if litterId does not exist",
    async () => {
      ...
      assertEquals(
        updateResult.error,
        `Litter with ID '${nonExistentLitterId}' not found.`,
      );
    },
  );
...
Deno.test("ReproductionTrackingConcept - recordOffspring action", async (t) => {
  ...
  await t.step(
    "should successfully record a new offspring with all details",
    async () => {
      ...
      const newOffspring = await concept.offspring.findOne({
        _id: offspringId,
      });
      ...
      assertEquals(
        newOffspring?.isAlive,
        true,
        "New offspring should be alive by default",
      );
      assertEquals(
        newOffspring?.survivedTillWeaning,
        false,
        "New offspring should not have survived weaning by default",
      );
    },
  );

  await t.step(
    "should successfully record a new offspring without optional notes, storing as empty string",
    async () => {
  ...
  await t.step(
    ...
    async () => {
      ...
      assertExists(
        result.error,
        "Error should be returned for non-existent litter",
      );
      ...
      const offspringCount = await concept.offspring.countDocuments({
        _id: offspringId,
      });
  ...
  await t.step(
    "should return an error if offspringId already exists",
    async () => {
      ...
      const initialOffspring = await concept.offspring.findOne({
        _id: offspringId,
      });
      ...
      assertExists(
        secondResult.error,
        "Error should be returned for duplicate offspring ID",
      );
      assertEquals(secondResult.offspringID, undefined);
      assertEquals(
        secondResult.error,
        `Offspring with ID '${offspringId}' already exists.`,
      );
      ...
      assertEquals(
        offspringCount,
        1,
        "Only one offspring record should exist for this ID",
      );
      const finalOffspring = await concept.offspring.findOne({
        _id: offspringId,
      });
      assertEquals(
        finalOffspring?.sex,
        sex,
        "Original offspring sex should not change",
      );
      assertEquals(
        finalOffspring?.notes,
        existingOffspringNotes,
        "Original offspring notes should not change",
      );
    },
  );
...
Deno.test("ReproductionTrackingConcept - updateOffspring action", async (t) => {
  ...
  await t.step("should successfully update a single field (sex)", async () => {
    ...
    const updatedOffspring = await concept.offspring.findOne({
      _id: offspringId,
    });
    assertExists(updatedOffspring);
    assertEquals(updatedOffspring?.sex, newSex);
    assertEquals(
      updatedOffspring?.litterId,
      litterId1,
      "Other fields should remain unchanged",
    );
    assertEquals(
      updatedOffspring?.notes,
      "Initial offspring notes",
      "Other fields should remain unchanged",
    );
  });

  await t.step(
    "should successfully update multiple fields (litterId, notes)",
    async () => {
      ...
      assertExists(
        litterRecordResult2.litterID,
        "Setup: Litter 2 must be created",
      );
      ...
      assertEquals(
        updatedOffspring?.sex,
        "female",
        "Other fields should remain unchanged (from previous step)",
      );
    },
  );
  ...
  await t.step(
    ...
    async () => {
      ...
      assertEquals(
        currentOffspring?.notes,
        "Original notes for non-update test",
      );
  ...
  await t.step(
    "should return an error if offspringId does not exist",
    async () => {
      ...
      assertEquals(
        updateResult.error,
        `Offspring with ID '${nonExistentOffspringId}' not found.`,
      );
    },
  );

  await t.step(
    "should return an error if new litterId does not exist",
    async () => {
      ...
      assertEquals(
        updateResult.error,
        `New litter with ID '${nonExistentLitterId}' not found.`,
      );
...
Deno.test("ReproductionTrackingConcept - recordWeaning action", async (t) => {
  ...
  let initialLiveOffspring = await concept.offspring.findOne({
    _id: liveOffspringId,
  });
  ...
  await t.step(
    "should successfully record weaning for an alive offspring",
    async () => {
      ...
      assertExists(updatedOffspring);
      assertEquals(
        updatedOffspring?.survivedTillWeaning,
        true,
        "survivedTillWeaning should be true",
      );
      assertEquals(
        updatedOffspring?.isAlive,
        true,
        "isAlive should remain true",
      );
    },
  );
  ...
  await t.step("should return an error if offspring is not alive", async () => {
    ...
    let deadOffspring = await concept.offspring.findOne({
      _id: deadOffspringId,
    });
    ...
    assertEquals(
      result.error,
      `Offspring with ID '${deadOffspringId}' is not alive and cannot be weaned.`,
    );
    ...
    assertExists(deadOffspring);
    assertEquals(
      deadOffspring.survivedTillWeaning,
      false,
      "survivedTillWeaning should remain false for dead offspring",
    );
  });
...
Deno.test("ReproductionTrackingConcept - recordDeath action", async (t) => {
  ...
  // Ensure initial state: alive, not weaned
  let initialLivingOffspring = await concept.offspring.findOne({
    _id: livingOffspringId,
  });
  ...
  await t.step(
    "should successfully record death for a living offspring that was not weaned",
    async () => {
      ...
      assertEquals(
        updatedOffspring?.isAlive,
        false,
        "isAlive should be false after death",
      );
      assertEquals(
        updatedOffspring?.survivedTillWeaning,
        false,
        "survivedTillWeaning should remain false if it was initially false",
      );
    },
  );
  ...
  await t.step(
    "should return an error if offspring is already marked as deceased",
    async () => {
      ...
      let alreadyDeadOffspring = await concept.offspring.findOne({
        _id: alreadyDeadOffspringId,
      });
      ...
      assertEquals(
        result.error,
        `Offspring with ID '${alreadyDeadOffspringId}' is already marked as deceased.`,
      );

      // Ensure state remains unchanged
      alreadyDeadOffspring = await concept.offspring.findOne({
        _id: alreadyDeadOffspringId,
      });
      assertExists(alreadyDeadOffspring);
      assertEquals(alreadyDeadOffspring.isAlive, false);
      assertEquals(
        alreadyDeadOffspring.survivedTillWeaning,
        false,
        "survivedTillWeaning should remain false if it was initially false",
      );
    },
  ...
  await t.step(
    "should preserve survivedTillWeaning status if offspring dies after weaning was recorded",
    async () => {
      ...
      await concept.recordWeaning({
        offspringId: weanedAndLivingOffspringId as string,
      });
      let weanedOffspring = await concept.offspring.findOne({
        _id: weanedAndLivingOffspringId,
      });
      ...
      const deadWeanedOffspring = await concept.offspring.findOne({
        _id: weanedAndLivingOffspringId,
      });
      assertExists(deadWeanedOffspring);
      assertEquals(
        deadWeanedOffspring.isAlive,
        false,
        "isAlive should be false after death",
      );
      assertEquals(
        deadWeanedOffspring.survivedTillWeaning,
        true,
        "survivedTillWeaning should remain true even after death if it was previously set",
      );
    },
  );
...
Deno.test("ReproductionTrackingConcept - generateReport action", async (t) => {
  ...
  await concept.recordOffspring({
    litterId: litterA1Id as string,
    offspringId: "offspring:OA1-1" as string,
    sex: "male",
  });
  await concept.recordOffspring({
    litterId: litterA1Id as string,
    offspringId: "offspring:OA1-2" as string,
    sex: "female",
  });
  await concept.recordOffspring({
    litterId: litterA1Id as string,
    offspringId: "offspring:OA1-3" as string,
    sex: "male",
  });
  // Make OA1-1 weaned
  ...
  await concept.recordOffspring({
    litterId: litterA2Id as string,
    offspringId: "offspring:OA2-1" as string,
    sex: "female",
  });
  await concept.recordOffspring({
    litterId: litterA2Id as string,
    offspringId: "offspring:OA2-2" as string,
    sex: "male",
  });
  await concept.recordOffspring({
    litterId: litterA2Id as string,
    offspringId: "offspring:OA2-3" as string,
    sex: "female",
  });
  ...
  await concept.recordOffspring({
    litterId: litterB1Id as string,
    offspringId: "offspring:OB1-1" as string,
    sex: "male",
  });
  await concept.recordOffspring({
    litterId: litterB1Id as string,
    offspringId: "offspring:OB1-2" as string,
    sex: "female",
  });
  await concept.recordOffspring({
    litterId: litterB1Id as string,
    offspringId: "offspring:OB1-3" as string,
    sex: "male",
  });
  await concept.recordOffspring({
    litterId: litterB1Id as string,
    offspringId: "offspring:OB1-4" as string,
    sex: "female",
  });
  ...
  await t.step(
    "should successfully generate a new report for a single target and date range",
    async () => {
      ...
      assertExists(
        generatedReport.results[0].includes(
          `Weaning Survival: ${expectedWeaningSurvival}`,
        ),
      );
      ...
      assertEquals(
        ...
        "",
        "New report summary should be an empty string",
      );
    },
  );

  await t.step(
    "should successfully generate a new report with no relevant data",
    async () => {
      ...
      const generatedReport = await concept.reports.findOne({
        _id: reportNameNoData as ID,
      });
      assertExists(generatedReport);
      assertEquals(generatedReport.target, [motherCId]);
      assertExists(
        generatedReport.results[0].includes(`Performance for ${motherCId}`),
      );
  ...
  await t.step(
    "should add performance for a different target to an existing report",
    async () => {
      ...
      assertEquals(
        ...
        "",
        "Summary should be cleared on update",
      ); // As report content changed
    },
  );

  await t.step(
    "should not add duplicate performance entry for the same target and range to an existing report",
    async () => {
      const target = motherAId;
      const currentReport = await concept.reports.findOne({
        _id: reportName1 as ID,
      });
      ...
      assertEquals(
        updatedReport.summary,
        "",
        "Summary should be cleared even if no new entry",
      );
    },
  );

  await t.step(
    "should add a new performance entry for the same target but a different date range",
    async () => {
      const target = motherAId;
      ...
      assertExists(
        updatedReport.results[initialResultsCount].includes(
          `Performance for ${target} (${newStartDateRange.toDateString()} to ${newEndDateRange.toDateString()}): `,
        ),
      );
      assertExists(
        updatedReport.results[initialResultsCount].includes(`Litters: 1`),
      );
      assertExists(
        updatedReport.results[initialResultsCount].includes(
          `Offspring: ${expectedOffspringCount}`,
  ...
  await t.step(
    "should return an error if target mother does not exist",
    async () => {
      ...
      assertEquals(
        result.error,
        `Target mother with ID '${nonExistentMotherId}' not found.`,
      );

      const reportCount = await concept.reports.countDocuments({
        _id: "InvalidReport" as ID,
      });
...
Deno.test("ReproductionTrackingConcept - renameReport action", async (t) => {
  ...
  let initialReport = await concept.reports.findOne({
    _id: originalReportName as ID,
  });
  ...
  await t.step("should successfully rename an existing report", async () => {
    ...
    const oldReport = await concept.reports.findOne({
      _id: originalReportName as ID,
    });
    assertEquals(oldReport, null, "Original report should no longer exist");

    const newReport = await concept.reports.findOne({
      _id: newReportName as ID,
    });
    assertExists(newReport);
    assertEquals(newReport._id, newReportName);
    assertEquals(
      newReport.results.length,
      1,
  ...
  await t.step(
    "should return an error if the old report name does not exist",
    async () => {
      ...
      assertEquals(
        result.error,
        `Report with name '${nonExistentReport}' not found.`,
      );
    },
  );

  await t.step(
    "should return an error if the new report name already exists",
    async () => {
      ...
      let existingNewReport = await concept.reports.findOne({
        _id: newReportName as ID,
      }); // From previous successful rename
      assertExists(
        existingNewReport,
        "New report name should already exist from previous step",
      );
      ...
      assertEquals(
        result.error,
        `Report with new name '${newReportName}' already exists.`,
      );

      // Verify the 'anotherOldName' report still exists and 'newReportName' report is untouched
      const reportStillExists = await concept.reports.findOne({
        _id: anotherOldName as ID,
      });
      assertExists(
        reportStillExists,
        "The report attempting to be renamed should still exist",
      );
      existingNewReport = await concept.reports.findOne({
        _id: newReportName as ID,
      });
      assertExists(
        existingNewReport,
        "The target new name report should remain untouched",
      );
    },
  );
...
Deno.test("ReproductionTrackingConcept - _viewReport query", async (t) => {
  ...
  await t.step(
    "should successfully retrieve the results of an existing report",
    async () => {
  ...
  await t.step(
    "should return an error if the report name does not exist",
    async () => {
      const nonExistentReport = "NonExistentViewReport";
      const result = await concept._viewReport({
...
Deno.test("ReproductionTrackingConcept - deleteReport action", async (t) => {
  ...
  let reportExists = await concept.reports.findOne({
    _id: reportToDeleteName as ID,
  });
  assertExists(reportExists, "Report to delete should exist initially");
  let otherReportExists = await concept.reports.findOne({
    _id: anotherReportName as ID,
  });
  ...
  await t.step("should successfully delete an existing report", async () => {
    const result = await concept.deleteReport({
      reportName: reportToDeleteName,
    });

    assertEquals(result, {}, "Empty object should be returned on success");
    assertEquals((result as { error?: string }).error, undefined);

    reportExists = await concept.reports.findOne({
      _id: reportToDeleteName as ID,
    });
    assertEquals(
      reportExists,
      null,
      "Report should no longer exist after deletion",
    );

    // Ensure other reports are not affected
    otherReportExists = await concept.reports.findOne({
      _id: anotherReportName as ID,
    });
...
Deno.test("ReproductionTrackingConcept - AI Summary actions", async (t) => {
  ...
  const highLitter1 = (await concept.recordLitter({
    motherId: motherHighPerformerId as string,
  ...
  for (let i = 1; i <= 5; i++) {
    ...
    await concept.recordOffspring({
      litterId: highLitter1 as string,
      offspringId: offspringId as string,
      sex: "male",
    });
  ...
  const highLitter2 = (await concept.recordLitter({
    motherId: motherHighPerformerId as string,
    birthDate: new Date("2023-06-01"),
  ...
  for (let i = 1; i <= 7; i++) {
    ...
    await concept.recordOffspring({
      litterId: highLitter2 as string,
      offspringId: offspringId as string,
      sex: "female",
    });
    await concept.recordWeaning({ offspringId: offspringId as string });
  ...
  const lowLitter1 = (await concept.recordLitter({
    motherId: motherLowPerformerId as string,
  ...
  const lowLitter2 = (await concept.recordLitter({
    motherId: motherLowPerformerId as string,
    birthDate: new Date("2023-07-01"),
    reportedLitterSize: 4,
  })).litterID!;
  ...
  const errorLitter1 = (await concept.recordLitter({
    motherId: motherRecordErrorId as string,
  ...
  for (let i = 1; i <= 10; i++) { // 10 offspring from a litter
    ...
    await concept.recordOffspring({
      litterId: errorLitter1 as string,
      offspringId: offspringId as string,
      sex: "male",
    });
  ...
  const avgLitter1 = (await concept.recordLitter({
    motherId: motherAveragePerformerId as string,
    birthDate: new Date("2023-08-01"),
    reportedLitterSize: 5,
  })).litterID!;
  for (let i = 1; i <= 5; i++) {
  ...
  await concept.generateReport({
    target: motherHighPerformerId as string,
    startDateRange: startDate,
    endDateRange: endDate,
    name: reportNameAI,
  });
  await concept.generateReport({
    target: motherLowPerformerId as string,
    startDateRange: startDate,
    endDateRange: endDate,
    name: reportNameAI,
  });
  await concept.generateReport({
    target: motherRecordErrorId as string,
    startDateRange: startDate,
    endDateRange: endDate,
    name: reportNameAI,
  });
  await concept.generateReport({
    target: motherAveragePerformerId as string,
    startDateRange: startDate,
    endDateRange: endDate,
    name: reportNameAI,
  });
  ...
  await t.step(
    "should generate a new AI summary when none exists for the report",
    async () => {
      ...
      } catch (e: unknown) { // Cast 'e' to 'unknown' explicitly, then you can work with it.
        const error = e instanceof Error ? e.message : String(e); // Safely get message
        throw new Error(
          `Failed to parse AI summary JSON: ${error}. Raw summary: ${result.summary}`,
        );
      }
      ...
      assertEquals(
        parsedSummary.highPerformers.includes(motherHighPerformerId),
        true,
        "High performer should be identified",
      );
      assertEquals(
        parsedSummary.lowPerformers.includes(motherLowPerformerId),
        true,
        "Low performer should be identified",
      );
      assertEquals(
        parsedSummary.potentialRecordErrors.includes(motherRecordErrorId),
        true,
        "Record error mother should be identified",
      );
      assertEquals(
        parsedSummary.averagePerformers.includes(motherAveragePerformerId),
        true,
        "Average performer should be identified",
      );

      assertNotEquals(
        parsedSummary.insights.length,
        0,
        "Insights should not be empty",
      );
      assertNotEquals(
        parsedSummary.insights.includes(
          "Do not focus on average/moderate performers",
        ),
        true,
        "Insights should not contain prompt text.",
      );
      assertNotEquals(
        parsedSummary.insights.includes("A few short paragraphs"),
        true,
        "Insights should not contain prompt text.",
      );
      ...
      assertEquals(
        report.summary,
        result.summary,
        "Generated summary should be saved to the database",
      );
    },
  );

  await t.step(
    "should return the cached AI summary without calling the AI again if one exists",
    async () => {
      let report = await concept.reports.findOne({ _id: reportNameAI as ID });
      assertExists(report);
      assertNotEquals(
        report.summary,
        "",
        "Report summary should already exist from previous step",
      );
      ...
      assertEquals(
        report.summary,
        cachedSummary,
        "Cached summary in DB should be untouched",
      );
    },
  );

  await t.step(
    "should successfully regenerate AI summary, overwriting the old one",
    async () => {
      let report = await concept.reports.findOne({ _id: reportNameAI as ID });
      assertExists(report);
      assertNotEquals(
        report.summary,
        "",
        "Report summary should exist before regeneration",
      );
      const oldSummary = report.summary;

      const result = await concept.regenerateAISummary({
      ...
      try {
        parsedSummary = JSON.parse(result.summary!) as LLMSummaryOutput;
      } catch (e: unknown) { // Cast 'e' to 'unknown' explicitly
        const error = e instanceof Error ? e.message : String(e);
        throw new Error(
          `Failed to parse regenerated AI summary JSON: ${error}. Raw summary: ${result.summary}`,
        );
      }
      ...
      assertEquals(
        parsedSummary.highPerformers.includes(motherHighPerformerId),
        true,
        "High performer should be identified in regenerated summary",
      );
      assertEquals(
        parsedSummary.lowPerformers.includes(motherLowPerformerId),
        true,
        "Low performer should be identified in regenerated summary",
      );
      assertEquals(
        parsedSummary.potentialRecordErrors.includes(motherRecordErrorId),
        true,
        "Record error mother should be identified in regenerated summary",
      );
      assertEquals(
        parsedSummary.averagePerformers.includes(motherAveragePerformerId),
        true,
        "Average performer should be identified in regenerated summary",
      );
      assertNotEquals(
        parsedSummary.insights.length,
        0,
        "Insights should not be empty in regenerated summary",
      );
      ...
      assertEquals(
        report.summary,
        result.summary,
        "Regenerated summary should be saved to the database",
      );
    },
  );
  ...
  await t.step(
    "should return an error if the report does not exist for regenerate AI summary",
    async () => {
      const nonExistentReport = "NonExistentAIReport";
      const result = await concept.regenerateAISummary({
        reportName: nonExistentReport,
